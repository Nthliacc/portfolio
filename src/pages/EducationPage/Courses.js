    ...
    return (
        <CoursesContainer>
            <CoursesItem background={'#024159'}>
                ...
                <p>4 anos - 2017</p>
                <p>
                O curso de Serviço Social da UnP tem o objetivo 
                de somar nas transformações que a sociedade exige, 
                formando um profissional competente em seu exercício 
                profissional, generalista em sua formação intelectual 
                e cultural.
                </p>
            </CoursesItem>
